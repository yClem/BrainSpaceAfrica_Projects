	...
	<body onclick="document.getElementById('myModal').style.display='none'"> 
			      ...
			      <div id="ImageSlider">
			      	<img id="mainImage" src="Content/Images/Prayer.jpg">
			      </div>


			      <div class="container" id="PrayerRequestDiv">

			      	<div class="container col-sm-12">
							      
					   <p id="contactAddress">Fields marked <span style="color:red">*</span> are required</p><br>
					   <input type="text" class="form-control bColor container" id="Name" placeholder="Name *"><br>
					   <input type="text" class="form-control bColor container" id="Name" placeholder="E-mail"><br>			
					   <textarea class="form-control bColor container" rows="6" placeholder="Prayer Request *"></textarea>
			                <br>
